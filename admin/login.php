		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2>Bienvenue Admin! Svp entrez votre mot de passe!</h2>
...
<!-- 							<div class="input-prepend" title="Username">
 ...
 -->
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="mot_de_passe" id="password" type="password" placeholder="Mot de passe"/>
							</div>
							<div class="clearfix"></div>
